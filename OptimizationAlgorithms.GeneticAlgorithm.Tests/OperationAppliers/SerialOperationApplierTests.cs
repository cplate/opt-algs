...
{
    [TestClass]
    public class SerialOperationApplierTests
    {
        private SerialOperationApplier<Candidate> _target;
        ...
        public void Init()
        {
            ...
            _target = new SerialOperationApplier<Candidate>(_decisionMaker);
        ...
        public void PerformCrossover_AppliesOperationProperly()
        {
            ...
            op.Expect(x => x.Crossover(_candidates.ElementAt(2), _candidates.ElementAt(4))).Return(expectedResult1);
            op.Expect(x => x.Crossover(_candidates.ElementAt(1), _candidates.ElementAt(3))).Return(expectedResult2);
